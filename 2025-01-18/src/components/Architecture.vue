    ...
    >
      ...
      <div class="grid grid-cols-2 mb-2 gap-x-3 gap-y-2">
        <div
          ...
          transition="all duration-500 ease-in-out"
          :class="[
            [0, 1, 2].includes($clicks) ? 'op-100' : 'op-50',
            $clicks >= 2 ? 'col-span-1' : 'col-span-2',
          ]"
        >
          <p text="$text-secondary" font-mono>
            @vitejs/plugin-vue
          </p>
      ...
      >
        <div mb-2>
          ...
          >
            SFC <span i-ri-arrow-right-fill relative top-0.5 inline-block /> JS Code
          </p>
        </div>
        <div grid grid-cols-2 gap-x-3 gap-y-2>
          ...
          >
            <div class="border-1 border-white rounded p-1">
              ...
              <p text-sm />
              <p>
                SFC <span i-ri-arrow-right-fill relative top-0.5 inline-block /> AST
              </p>
            </div>
            <div class="border-1 border-white rounded p-1">
              <p text="$text-secondary" font-mono>
              ...
              <p text-sm />
              <p>
                SFC AST <span i-ri-arrow-right-fill relative top-0.5 inline-block /> IR
              </p>
            </div>
          </div>
          <!-- @vue/jsx-vapor -->
          ...
          >
            <div>
              ...
              <p text-sm />
              <p>
                JSX <span i-ri-arrow-right-fill relative top-0.5 inline-block /> IR
              </p>
            </div>
            <div flex-1 />
          ...
          <div
            class="border-1 border-white rounded p-1 w-full"
            col-span-2
            transition="all duration-500 ease-in-out"
            :class="[
      ...
      <!-- 底部的方框 -->
      <div
        class="border-1 border-white rounded bg-gray/40 p-1 op-100"
        transition="all duration-500 ease-in-out"
        :class="[
          $clicks >= 2 ? 'text-right' : 'text-left',
        ]"
      >
        ...
        <p text-sm>
          Final Result｜<span font-jp>最終結果</span>
        </p>
      </div>
      <!-- 箭头 -->
      <div>
        ...
        <div
          ...
          pb-16
          transition="all duration-500 ease-in-out"
          :class="$clicks >= 2 ? 'translate-y-0' : 'translate-y--100 op0'"
        >
          <div
            border="$color-jsx"
            w-full
